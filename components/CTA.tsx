  ...
  return (
    <section className='px-4 sm:px-12 mt-20 bg-(--color-sec-bg)'>
        <div className='w-full h-full flex flex-col items-center justify-center py-20'>
            <h1 className="title text-white">Spremni za sljedeći korak?</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                <a><button className='btn bg-white text-black'>Pošaljite upit <ArrowRight /></button></a>
                <a className='text-white'>Ili nas nazovite</a>
            </div>
        </div>
    </section>
  )
